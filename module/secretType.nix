  ...
  secretType = types.submodule (submod: {
    options = {
      id = mkOption {
        ...
        readOnly = true;
        description = "The true identifier of this secret as used in `kix.secrets`.";
      };
      name = mkOption {
        type = types.str;
        default = submod.config._module.args.name;
        ...
        description = ''
          Filename of the file while extracting to {option}`kix.settings.decryptedDir`
        '';
      };
      file = mkOption {
        type = types.path;
                ...
                let
                  path =
                    (lib.concatMapStrings (x: "/" + x) [
                      self
                      (self.kix.defaultSecretDirectory or "./secrets")
      ...
      insert = mkOption {
        ...
        description = ''
          ...
          See <https://milieuim.github.io/vaultix/advanced.html>.
        '';
      };
    };
  });
